...
<head>
	<title>PizzaParty-Our Story</title>
...
<body>
	...
	<div class="container">
		...
		<p>After a short stay at Ellis Island. Their name was shortened to <i>"Pardi"</i>, they lived in New York City until
			...
			as our Hertel Avenue and UB locations.</p><br />
		<p>Carlo and Giovanni Pardi NYE Havana, Cuba. 1958 (colorized).</p>

		<img src="img/party_boys.jpg" Alt="Pardi Bros Havana NYE 1958 colorized" style="width:560px;height:325px"><br />
		<hr />

		<p>Royal Treatment</p>
		<iframe width="560" height="315" src="https://www.youtube.com/embed/CPEwAA6G42I?start=15" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
